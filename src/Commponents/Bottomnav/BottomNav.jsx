  ...
  return (
   <BottNavbar>
    <div className="botcontainer">
      ...
      <div className={`${window.location.pathname==="/allusers"?"active":"menus"} dfc ac `} onClick={()=>navigate("/search")} ><span><AiOutlineSearch size={25}/></span> <span  className='icontitle'>Search</span></div>
